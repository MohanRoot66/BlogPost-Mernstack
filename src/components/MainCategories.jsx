  ...
  return (
    <div className='hidden md:flex bg-white rounded-3xl xl:rounded-full p-4 shadow-lg items-center justify-center gap-8'>
        ...
        <div className="flex-1 flex items-center justify-between flex-wrap">
            ...
            <Link to="/posts?cat=databases" className='hover:bg-blue-50  rounded-full px-4 py-2'>Development</Link>
            <Link to="/posts?" className='hover:bg-blue-50  rounded-full px-4 py-2'>Databases</Link>
            <Link to="/posts?" className='hover:bg-blue-50  rounded-full px-4 py-2'>Search Engines</Link>
